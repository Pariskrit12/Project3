...
const ChatCard = ({image,username,messageSnip}) => {
  ...
  return (
    <>
    <div onClick={()=>setOpenChat(true)} className='flex border border-[#E8D5C0] bg-[#FDF6EE] shadow-[0_2px_8px_rgba(164,57,25,0.08)] gap-3 items-center px-4 py-3 rounded-xl hover:shadow-[0_4px_16px_rgba(164,57,25,0.14)] hover:bg-[#FAF0E6] transition-all duration-200 cursor-pointer '>
