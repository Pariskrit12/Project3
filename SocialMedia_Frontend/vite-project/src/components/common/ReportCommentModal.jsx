        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#2A2A2A]">
          <div className="flex items-center gap-2.5">
            <div className="bg-red-500/10 p-1.5 rounded-lg">
              <Icon icon="mdi:flag-outline" width="18" height="18" className="text-red-400" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-5 py-5">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-red-500 text-white text-sm font-bold disabled:opacity-50 hover:bg-red-600 transition-colors"
              >
