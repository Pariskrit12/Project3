    ...
    <main className="grid grid-cols-2 gap-6">
          ...
          {picFile && (
            <div className="flex flex-col items-center gap-1.5">
              ...
              <button
                ...
                className="text-xs text-[#9A9A9A] hover:text-[#CC3600] transition-colors"
              >
                Cancel
              </button>
            </div>
      ...
      <section className="flex items-center justify-center px-5">
        {activeField === "deactivate" ? (
          <div className="flex flex-col items-center w-90 gap-5 p-8 bg-[#1E1E1E] border border-red-200 rounded-2xl shadow-[0_4px_24px_rgba(239,68,68,0.1)]">
            ...
            <div className="flex items-center gap-3 w-full p-3 bg-red-50 rounded-xl border border-red-100">
              ...
              <div>
                <p className="font-bold text-sm text-[#D7DADC]">{user?.name}</p>
                <p className="text-xs text-[#9A9A9A]">{user?.email}</p>
              </div>
            </div>

            <div className="text-center">
              <h2 className="font-black text-lg text-[#D7DADC] mb-1">Deactivate Account?</h2>
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-full border border-[#3A3A3C] text-[#A83200] font-bold text-sm hover:bg-[#2A2A2A] transition-all duration-200 cursor-pointer"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="flex flex-col items-center w-90 gap-5 p-8 bg-[#1E1E1E] border border-[#3A3A3C] rounded-2xl shadow-[0_4px_24px_rgba(255,69,0,0.1)]">
            ...
            <h2 className="font-black text-lg text-[#D7DADC]">
          ...
          <div className="flex flex-col items-center gap-4 text-center p-8">
            <div className="bg-[#2A2A2A] rounded-full p-6 shadow-inner">
              <Icon icon="mdi:user" width="44" height="44" className="text-[#9A9A9A]" />
            </div>
            <div>
              <p className="text-lg font-bold text-[#D7DADC]">
